...
model = tf.keras.models.load_model(r"D:\DoAnTotNghiep\model_4_chu_cai\model_4ChuCai_10e-6_data6_2_trainfull.h5")
label_dict = {'D': 0, 'H': 1, 'U': 2, 'V': 3, 'nothing1' : 4}
    ...
    while True:
        if frame_for_prediction is not None:
            try:
                ...
                if confidence >= 0.9:
                    predicted_char = reversed_dict[predicted_label]
                    """
